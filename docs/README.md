# 📚 Dokumentasi NusaFlow AI

Folder ini berisi dokumentasi teknis dan perencanaan untuk project NusaFlow AI.
...
1. Gunakan format **Markdown** untuk semua dokumen.
2. Pastikan setiap perubahan di-review sebelum di-merge.
3. Sertakan tanggal update di bagian bawah dokumen jika ada perubahan signifikan.
